...
out.dir = paste0(output,'/NonPAR-X-ig/')
dir.create(out.dir)
...
fwrite(log_exprs_df_parx,paste0(out.dir2,"/", cellLabel,'_nonPAR_X_ig_expression.tsv'),sep="\t")
...
fwrite(gene_snp_df,paste0(out.dir2,"/", cellLabel,'_nonPAR_X_ig_gene-snp_pairs.tsv'),sep="\t")
...
fwrite(log_residual_df,paste0(out.dir2,"/", cellLabel,'_nonPAR_X_ig_log_residuals.tsv'),sep="\t")
...
fwrite(genotype_df2,paste0(out.dir2,"/", cellLabel,'_nonPAR_X_ig_genotypes.tsv'),sep="\t")
