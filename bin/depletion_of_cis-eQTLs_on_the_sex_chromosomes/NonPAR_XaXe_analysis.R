...
out.dir = paste0(output,'/NonPAR-XaXe/')
dir.create(out.dir)
...
fwrite(log_exprs_df_parx,paste0(out.dir2,"/", cellLabel,'_nonPAR_XaXe_expression.tsv'),sep="\t")
...
fwrite(gene_snp_df,paste0(out.dir2,"/", cellLabel,'_nonPAR_XaXe_gene-snp_pairs.tsv'),sep="\t")
...
fwrite(gene_snp_df,paste0(out.dir2,"/", cellLabel,'_nonPAR_XaXe_log_residuals.tsv'),sep="\t")

genotype_df <- genotype_df %>% filter(sampleid %in% log_exprs_df_parx$sampleid)

fwrite(genotype_df,paste0(out.dir2,"/", cellLabel,'_nonPAR_XaXe_genotypes.tsv'),sep="\t")
...
fwrite(log_spearman_df,sprintf("%s/%s_nonPAR_XaXe_correlation_results.tsv", out.dir2, cellLabel),sep="\t",quote=F)
...
fwrite(log_spearman_df_significant,sprintf("%s/%s_nonPAR_XaXe_significant_correlation_results.tsv", out.dir2, cellLabel),sep="\t",quote=F)
