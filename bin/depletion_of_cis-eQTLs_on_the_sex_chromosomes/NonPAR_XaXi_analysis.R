...
out.dir = paste0(output,'/NonPAR-XaXi/')
dir.create(out.dir)
...
fwrite(log_exprs_df_parx,paste0(out.dir2,"/", cellLabel,'_nonPAR_XaXi_expression.tsv'),sep="\t")
...
fwrite(gene_snp_df,paste0(out.dir2,"/", cellLabel,'_nonPAR_XaXi_gene-snp_pairs.tsv'),sep="\t")
...
fwrite(log_residual_df,paste0(out.dir2,"/", cellLabel,'_nonPAR_XaXi_log_residuals.tsv'),sep="\t")

genotype_df <- genotype_df %>% filter(sampleid %in% log_exprs_df_parx$sampleid)

fwrite(genotype_df,paste0(out.dir2,"/", cellLabel,'_nonPAR_XaXi_genotypes.tsv'),sep="\t")
