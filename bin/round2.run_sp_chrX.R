...
# Input filenames
r1_residual_filename <- sprintf("%s/%s/%s_chrX_log_residuals.tsv",output, cellLabel, cellLabel)
r1_significant_SNPs <- sprintf("%s/%s/%s_chrX_round1_significant_correlation_results.tsv",output,cellLabel, cellLabel)
...
fwrite(eSNP1,sprintf("%s/%s_chrX_eSNP1.tsv",out.dir,cellLabel),sep="\t",quote=F)
...
fwrite(adjusted_residual_df,sprintf("%s/%s_chrX_eSNP1_adjusted_residuals.tsv",out.dir, cellLabel),sep="\t",quote=F)
...
fwrite(adjusted_spearman_df,sprintf("%s/%s_chrX_round2_correlation_results.tsv",out.dir, cellLabel),sep="\t",quote=F)
...
fwrite(adjusted_spearman_df_significant,sprintf("%s/%s_chrX_round2_significant_correlation_results.tsv",out.dir, cellLabel),sep="\t",quote=F)
