...
fwrite(log_residual_df,sprintf("%s/round1/%s_chr23_log_residuals_male.tsv", out.dir, cellLabel),sep="\t",quote=F)
...
fwrite(log_spearman_df,sprintf("%s/round1/%s_chr23_correlation_results_male.tsv", out.dir, cellLabel),sep="\t",quote=F)
...
fwrite(log_spearman_df_significant,sprintf("%s/round1/%s_chr23_significant_correlation_results_male.tsv", out.dir, cellLabel),sep="\t",quote=F)
