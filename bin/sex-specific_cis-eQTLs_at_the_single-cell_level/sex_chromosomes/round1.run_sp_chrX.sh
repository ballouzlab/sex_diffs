...
# Main script file
RSCRIPT="/directflow/SCCGGroupShare/projects/SeyhanYazar/onek1k/sex_specific_eQTL_analysis/scripts/round1.run_sp_chrX.R"

# Do the main job
${R_PATH}/Rscript ${RSCRIPT} ${CELLLABEL} ${SAMPLE} > rout/round1C_${CELLLABEL}_${SAMPLE}.Rout
