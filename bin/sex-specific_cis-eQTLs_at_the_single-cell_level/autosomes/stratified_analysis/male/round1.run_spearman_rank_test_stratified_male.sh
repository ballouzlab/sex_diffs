...
# per chromosome for 14 cell types using "round1.run_spearman_rank_test.R" script. 
...
CTYPEFILE="/directflow/SCCGGroupShare/projects/SeyhanYazar/onek1k/sex_specific_eQTL_analysis/scripts/all_cells_array" 
...
# Main script file
RSCRIPT="/directflow/SCCGGroupShare/projects/SeyhanYazar/onek1k/sex_specific_eQTL_analysis/scripts/round1.run_spearman_rank_test_stratified_male.R"

# Do the main job
${R_PATH}/Rscript ${RSCRIPT} ${CELLLABEL} ${SAMPLE} > rout/round1_${CELLLABEL}_${SAMPLE}.Rout
