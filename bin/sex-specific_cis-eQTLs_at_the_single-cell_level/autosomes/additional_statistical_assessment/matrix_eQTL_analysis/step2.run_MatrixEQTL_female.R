...
setwd(sprintf('results/2022-10-04_matrix-eqtl-analysis-female/%s',cellType))
...
fwrite(cisEQTLs, sprintf("%s/%s_chr%s_cis_eqtls.tsv", out.dir, cellType, chrNumber), quote=F,row.names=F,sep="\t")
