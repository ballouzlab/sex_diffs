...
# Set output ------------------------------------------
output <- set_output("2022-10-04", "matrix-eqtl-analysis-female")
...
residuals <- fread(sprintf("/directflow/SCCGGroupShare/projects/SeyhanYazar/onek1k/sex_specific_eQTL_analysis/results/2022-07-13_female_only/%s/round1/%s_chr22_log_residuals_female.tsv", cellType,cellType))
